...
class ArticleList extends StatelessWidget {
  final List<Article> articles = new List.generate(
      ...
      (i) => new Article(
          title: 'artice $i',
          content:
              'article content $i The quick brown fox jumps over the lazy dog'));
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return new Scaffold(
      appBar: new AppBar(title: new Text("actile list")),
          ...
          return new ListTile(
              ...
              onTap: () async {
                String result = await Navigator.push(
                    context,
//                      new MaterialPageRoute(builder: (context) => new Content(articles[index]))
                    // popupRouter 效果
                    new PageRouteBuilder(
                        pageBuilder: (context, _, __) =>
                            new Content(articles[index]),
...
class Content extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // TODO: implement build
    return new Scaffold(
        appBar: new AppBar(title: new Text('${article.title}')),
        body: new Padding(
